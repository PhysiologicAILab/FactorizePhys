...
class encoder_block(nn.Module):
    def __init__(self, inCh, dropout_rate=0.1, debug=False):
        ...
        self.encoder1 = nn.Sequential(
            ...
            ConvBlock3D(nf[1], nf[1], [3, 3, 3], [1, 2, 2], [1, 0, 0]), #B, nf[1], 160, 15, 15
            ConvBlock3D(nf[1], nf[2], [3, 3, 3], [1, 1, 1], [1, 0, 0]), #B, nf[2], 160, 13, 13
        ...
        self.encoder2 = nn.Sequential(
            ...
            ConvBlock3D(nf[2], nf[3], [3, 3, 3], [1, 1, 1], [1, 0, 0]), #B, nf[3], 160, 7, 7
            nn.Dropout3d(p=dropout_rate),
            # ConvBlock3D(nf[3], nf[3], [3, 1, 1], [1, 1, 1], [1, 0, 0]), #B, nf[3], 160, 7, 7
        )
...
class BVP_Head(nn.Module):
    def __init__(self, md_config, device, dropout_rate=0.1, debug=False):
        ...
        self.conv_decoder = nn.Sequential(
            nn.Conv3d(inC, nf[0], (3, 5, 5), stride=(1, 1, 1), padding=(1, 0, 0), bias=False),  #B, nf[0], 160, 3, 3
            nn.Tanh(),
